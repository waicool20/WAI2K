...
class EventES_1_Inf_SPP1(scriptComponent: ScriptComponent) : EventES_1_Inf(scriptComponent)
class EventES_1_Inf_KSVK(scriptComponent: ScriptComponent) : EventES_1_Inf(scriptComponent)

sealed class EventES_1_Inf(scriptComponent: ScriptComponent) :
    HomographyMapRunner(scriptComponent), EventMapRunner {
    private val logger = loggerFor<EventES_1_Inf>()
    ...
    override suspend fun enterMap() {
        ...
        region.subRegion(1334, 472, 78, 20).click()
        delay(1000)
