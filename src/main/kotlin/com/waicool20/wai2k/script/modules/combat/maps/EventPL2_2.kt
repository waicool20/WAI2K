...
class EventPL2_2(scriptComponent: ScriptComponent) : AbsoluteMapRunner(scriptComponent),
    EventMapRunner {
    private val logger = loggerFor<EventPL2_2>()
    ...
    override suspend fun enterMap() {
        ...
        if (gameState.requiresMapInit) {
            ...
            region.subRegion(1025, 580, 121, 30).click()
        }
        delay(1000)
