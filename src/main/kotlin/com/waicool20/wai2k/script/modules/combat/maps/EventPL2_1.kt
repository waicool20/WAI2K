...
class EventPL2_1(scriptComponent: ScriptComponent) : AbsoluteMapRunner(scriptComponent),
    EventMapRunner {
    private val logger = loggerFor<EventPL2_1>()
    ...
    override suspend fun enterMap() {
        ...
        if (gameState.requiresMapInit) {
            ...
            region.subRegion(500, 310, 1000, 100)
                .findBest(FileTemplate("$PREFIX/entrance.png"))?.region?.click()
        } else {
            region.subRegion(650, 310, 121, 40).click()
        }
        delay(1000)
