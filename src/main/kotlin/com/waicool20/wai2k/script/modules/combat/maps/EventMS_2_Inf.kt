...
class EventMS_2_Inf(scriptComponent: ScriptComponent) :
    HomographyMapRunner(scriptComponent),
    EventMapRunner {
    private val logger = loggerFor<EventMS_2_Inf>()
    ...
    override suspend fun enterMap() {
        if (gameState.requiresMapInit) {
            ...
            logger.info("Entering Chapter 2")
            region.subRegion(1470, 240, 100, 100).click()
            delay(2500)
        ...
        // Click on map pin
        region.subRegion(1305, 620, 30, 30).click()
