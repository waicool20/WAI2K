...
class EventGSGPinocchio(scriptComponent: ScriptComponent) : HomographyMapRunner(scriptComponent), EventMapRunner {
    private val logger = loggerFor<EventGSGPinocchio>()
    ...
    override suspend fun enterMap() {
        ...
        region.subRegion(1408, 835, 116, 25).click() // Honest Pinocchio
        delay(2000)
    ...
    override suspend fun begin() {
        ...
        waitForTurnEnd(2, false) // Kill them in 1 turn so they don't escape
        delay(500)
        terminateMission() // Don't bother saving resources
    }
