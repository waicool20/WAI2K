...
class EventDivision1_1(scriptComponent: ScriptComponent) : HomographyMapRunner(scriptComponent),
    EventMapRunner {
    private val logger = loggerFor<EventDivision1_1>()
    ...
    override suspend fun enterMap() {
        ...
        if (gameState.requiresMapInit) {
            ...
            region.subRegion(566, 907, 30, 30).click() // hopefully map box is here
        } else {
            delay((1000 * gameState.delayCoefficient).roundToLong())
            region.subRegion(630, 946, 30, 30).click()
        }
    ...
    override suspend fun resetView() {
        ...
        logger.info("Pan up")
        val r = region.subRegionAs<AndroidRegion>(450, 300, 150, 151)
        r.swipeTo(r.copy(y = r.y + Random.nextInt(300, 400)), 500)
        delay(500)
