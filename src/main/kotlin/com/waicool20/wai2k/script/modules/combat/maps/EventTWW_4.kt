...
class EventTWW_4(scriptComponent: ScriptComponent) : HomographyMapRunner(scriptComponent),
    EventMapRunner {
    private val logger = loggerFor<EventTWW_4>()

    override suspend fun enterMap() {
        region.subRegion(1349, 707, 460, 229).click() // Last of the Summer Days
